...
CREATE TABLE `product_attributes` (
  ...
  CONSTRAINT `product_attributes_ibfk_1` FOREIGN KEY (`productId`) REFERENCES `products` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `product_attributes_ibfk_2` FOREIGN KEY (`attributeId`) REFERENCES `attribues` (`id`) ON UPDATE CASCADE
